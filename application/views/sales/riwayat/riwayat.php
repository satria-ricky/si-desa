        ...
        <div class="panel-header bg-primary-gradient">
          <div class="page-inner py-5">
            ...
            <div class="page-header text-white">
              <h4 class="page-title text-white">Riwayat</h4>
              <input type="hidden" id="id_sales" value="<?= $data_pengguna['user_id'];?>">
              <ul class="breadcrumbs">
                ...
                <li class="nav-item ">
                  <a href="#" class="text-white">Daftar riwayat</a>
                </li>
...
<button id="pdf_button" class="btn btn-danger" >Export to PDF</button> 
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="rute_select" onchange="get_toko()">
                    ...
                    "columns": [
                        ...
                        },
                        {
                            ...
                            return `
                              ...
                              <button class="btn btn-danger btn-xs btn-round" onclick="cetak(${row.main_id})"> Cetak nota </button>  
                              `;
                            }
                        }
                      ],
                      ...
                      "footerCallback": function ( row, data, start, end, display ) {
                        ...
                        // Update footer
                        $( api.column( 3 ).footer()).html(stok_sepray_total);
                        $( api.column( 4 ).footer()).html(stok_roll_total);
                        $( api.column( 7 ).footer()).html('Rp. '+sepray_total.toLocaleString());
                        $( api.column( 8 ).footer()).html('Rp. '+roll_total.toLocaleString());
                        $( api.column( 9 ).footer()).html(bonus_sepray_total);
                        $( api.column( 10 ).footer()).html(bonus_roll_total);
                    }  
...
function get_toko() {
  ...
  $('#pdf_button').click(function(e) {
    ...
    window.open("<?php echo base_url('auth/pas_pdf?')?>sales="+sales+ "&tanggal1="+tanggal1+ "&tanggal2=" +tanggal2+ "&rute=" +id_rute+ "&toko=" +id_toko,"_blank");

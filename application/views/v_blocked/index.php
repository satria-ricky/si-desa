...
<head>
  ...
  <link rel="icon" type="image/png" href="<?= base_url('assets_blocked/'); ?>img/favicon.ico">
  <link href="<?= base_url('assets_blocked/'); ?>css/style.css" rel="stylesheet">
</head>
...
<body>
      ...
      <div id="svgForyou" class="center" style="width: 100%;
  text-align: center;">
        <svg id="mainImage_create" data-name="mainImage" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 171.2 81.5">
          ...
          <text id="title" transform="matrix(1 0 0 1 44.7249 78)">ANTUM JANGAN JAHIL !
            <br>
            <button onclick="goBack()" style="cursor: pointer; color: blue;" > &larr; Balik yaa :) </button>
          </text>
